...
from lstm import ConvTransformerApproximator as Approximator
...
def run_on_signal():
    ...
    # Model
    model = Approximator(signal_dim=input_shape, d_model=256, num_layers=2, nhead=4,
                         lr=0.01).to(device)

    # Train
    model.train_model(train_loader, val_loader=val_loader, num_epochs=20)
