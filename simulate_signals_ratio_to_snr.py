...
ground_truth = []
linreg_slope_list = np.zeros(n_linreg_cycles)
linreg_intercept_list = np.zeros(shape=n_linreg_cycles)


ratio_snr_pairs = [None]*n_sims
for j in range(n_linreg_cycles):
    ...
    linreg_slope_list[j]=linreg.slope
    linreg_intercept_list[j]=linreg.intercept
